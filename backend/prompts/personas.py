...
PERSONAS = {
    ...
    "iim_general": {
        ...
        "behavioral_rules": [
            ...
            "Inject highly unpredictable 'googly' or situational questions out of the blue (e.g., 'If your favorite actor did a pan masala ad, what would you rate them?' or bizarre hypothetical scenarios) to see how they handle surprise topics",
            "Test academic presence of mind with sudden on-the-spot calculations or domain-specific logic questions based on their 12th/Graduation subjects (e.g., 'Calculate your exact percentage on the spot' or a specific scenario on Staffing if they studied Business Studies)",
